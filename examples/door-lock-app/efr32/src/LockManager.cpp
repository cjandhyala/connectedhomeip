...
void LockManager::EnableAutoTurnOff(bool aOn)
{
    mAutoTurnOff = aOn;
}

void LockManager::SetAutoTurnOffDuration(uint32_t aDurationInSecs)
{
...
{
    ChipLogProgress(Zcl, "Door Lock App: LockManager::GetCredential [credentialType=%u]", to_underlying(credentialType));
